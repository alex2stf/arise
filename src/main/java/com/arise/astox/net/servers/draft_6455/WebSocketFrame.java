 ...
 */
public class WebSocketFrame extends DuplexDraft.Frame {
    ...
    public String getPayloadText()
    {
        ...
        return ByteUtil.toStringUTF8(mPayload);
    }
    ...
    public WebSocketFrame setPayload(String payload) {
        ...
        return setPayload(ByteUtil.getBytesUTF8(payload));
    }
    ...
    public WebSocketFrame setCloseFramePayload(int closeCode, String reason) {
        ...
        byte[] encodedReason = ByteUtil.getBytesUTF8(reason);
    ...
    public String getCloseReason() {
        ...
        return ByteUtil.toStringUTF8(mPayload, 2, mPayload.length - 2);
    }
    ...
    public String toString()
    {
        StringBuilder builder = new StringBuilder()
            ...
            .append(",FrameCode=").append(toOpcodeName(mOpcode))
    ...
    /*
    public static WebSocketFrame compressFrame(WebSocketFrame frame, PerMessageCompressionExtension pmce)
    {
    ...
    public static List<WebSocketFrame> splitIfNecessary(
