...
public class WebSocketOutputStream extends FilterOutputStream
{
    ...
    public void write(String string) throws IOException
    {
        ...
        byte[] bytes = ByteUtil.getBytesUTF8(string);
    ...
    public void write(WebSocketFrame frame) throws IOException
    {
        ...
        byte[] maskingKey = ByteUtil.randBytes(4);
    ...
    public void writeFrame0(WebSocketFrame frame) throws IOException
    {
    ...
    public void writeFrame1(WebSocketFrame frame) throws IOException
    {
    ...
    public void writeFrameExtendedPayloadLength(WebSocketFrame frame) throws IOException
    {
        int len = frame.getPayloadLength();
    ...
    public void writeFramePayload(WebSocketFrame frame, byte[] maskingKey) throws IOException
    {
