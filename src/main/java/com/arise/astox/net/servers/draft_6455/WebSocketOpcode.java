...
{
    /**
     * FrameCode for "frame continuation" (0x0).
     */
    public static final int CONTINUATION = 0x0;


    /**
     * FrameCode for "text frame" (0x1).
     */
    public static final int TEXT = 0x1;


    /**
     * FrameCode for "binary frame" (0x2).
     */
    public static final int BINARY = 0x2;


    /**
     * FrameCode for "connection close" (0x8).
     */
    public static final int CLOSE = 0x8;


    /**
     * FrameCode for "ping" (0x9).
     */
    public static final int PING = 0x9;


    /**
     * FrameCode for "pong" (0xA).
     */
