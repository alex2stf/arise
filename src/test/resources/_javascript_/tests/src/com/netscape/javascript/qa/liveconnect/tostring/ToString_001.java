...
/**
 *  SomeJSObject.strDump() should return the same String value as
 *  SomeJSObject.call( "strDump", null ) and
 ...
 *  gets the string value of the object using strDump
 *  
 *
...
public class ToString_001	extends	LiveConnectTest	{
    ...
    public void getStrings( JSObject jsObject, Object[] data ) {
        ...
        try {
            ...
            resultOfCall    = (String) jsObject.call( "strDump", null );
        } catch ( Exception e ) {
            ...
            addTestCase(
                "[ jsObject.strDump returned " + jsObject.toString() +" ]"+
                "( " + jsObject +" ).strDump().equals( " + eString +" )",
                "true",
                jsObject.toString().equals(eString) +"",
                file.exception );
                
            addTestCase(
                "[ calling strDump returned " + resultOfCall +" ]"+
                "( " + jsObject +".call( \"strDump\", null ).equals(" + eString+")",
                "true",
