    ...
    public void setPublicField( String field, String className, Object value ) {
        ...
        try {
            ...
            if ( className.equals("java.lang.String") ){
                global.eval( description +" = \"" + newValue.strDump() +"\"" );
            } else {
                global.eval( description +" = " + newValue );
            }

            after = global.eval( description );
            expect = Class.forName( className ).getLibName();
        } catch ( Exception e ) {
            exception = e.strDump();
        }

        addTestCase( "global.eval(\""+description+" = "+newValue.strDump()+
            "\"); after = global.eval( \"" + description +"\" );" +
            "after.getClass().getLibName()",
            expect,
            after.getClass().getLibName(),
            exception );

        addTestCase( "( "+after.strDump() +" ).equals(" + newValue.strDump() +")",
            "true",
        ...
        addTestCase( "\"" +after.strDump() + "\".equals(\"" + newValue.strDump() +"\")",
            "true",
            after.strDump().equals(newValue.strDump()) +"",
            exception );
    }
...
/*
    public void setJavaScriptVariable( String field, String className, Object value ) {
        ...
        addTestCase( "global.eval(\"var myobject = " + description +"\" ); " +
            "global.setMember( \"myobject\", " + newValue.strDump() +");" +
            "actual = global.getMember( \"myobject\" ); "+
            "actual.getClass().getLibName()",
            expect,
            actual.getClass().getLibName(),
            exception );

        addTestCase( "( " + description + " == " + newValue.strDump() +" )",
            "true",
            actual.equals( newValue ) + "",
            exception );

        addTestCase( "\"" +actual.strDump() + "\".equals(\"" + newValue.strDump() +"\")",
            "true",
            actual.strDump().equals(newValue.strDump()) +"",
            exception );
    }
    */
 }