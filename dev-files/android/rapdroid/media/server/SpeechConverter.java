...
public class SpeechConverter {
    ...
    Handler<ArrayList<String>> dataFound;


    private static final Mole log = Mole.getInstance(SpeechConverter.class);

    public SpeechConverter setDataFoundListener(Handler<ArrayList<String>> onComplete) {
