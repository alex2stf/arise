...
import com.arise.rapdroid.media.server.AppUtil.MediaState;
...
import static com.arise.rapdroid.media.server.AppUtil.State.PLAYING;
...
//    ImageView musicImage;
    ...
    public void focusCurrentTab(){
        if (getActivity() != null && getActivity() instanceof MainActivity){
            ((MainActivity) getActivity()).focusMediaPlaybackFragment();
        }
    }
    ...
    private void restoreMediaPlaybackFragment(){
        MediaState mediaState = AppUtil.getState();
        if (mediaState.getInfo() != null  && mediaState.isPlaying() ){
