...
public class BluetoothHttpClient  {
    ...
    @Override
    public void connect(HttpRequest request, Handler<BluetoothSocket> connectHandler) {
...
//                    connectHandler.ha(socket);
    ...
    @Override
    public void sendAndReceive(HttpRequest request, Handler<HttpResponse> responseHandler) {
...
//                        ex.printStackTrace();
    ...
    class Message {
        HttpRequest request;
        Handler<HttpResponse> onComplete;
    }
}
